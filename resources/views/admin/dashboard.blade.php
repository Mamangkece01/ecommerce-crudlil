        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-6 mb-8 border-2 border-gray-500/20">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div class="flex items-center justify-center h-14 w-14 rounded-full bg-gray-900 text-white text-2xl shadow-inner">
                            👤
                        </div>
                        <div>
                            ...
                            <p class="text-gray-500 text-sm font-bold uppercase tracking-widest">DI SECOND CAR STORE</p>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl border-b-8 border-gray-800 p-6">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="inline-flex items-center gap-2 text-white bg-gray-900 px-4 py-2 rounded-lg text-xs font-black uppercase hover:bg-black transition-colors mt-4">Kelola Pengguna →</a>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl border-b-8 border-gray-800 p-6">
                    ...
                    <div class="mt-6 text-green-600 font-black text-xs flex items-center gap-2 bg-green-50 px-4 py-2 rounded-lg border border-green-200">
                        <span class="h-2 w-2 bg-green-600 rounded-full animate-pulse"></span> ADMIN MODE
                    </div>
                </div>
            </div>
