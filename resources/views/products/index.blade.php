            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
                <div class="space-y-1">
                    <h1 class="text-4xl font-black text-white tracking-tight uppercase">
                        Music <span class="text-indigo-500">Catalog</span>
                    </h1>
                    <p class="text-slate-400 font-medium">Temukan gear impianmu di sini.</p>
                </div>
                ...
                @foreach($products as $product)
                    <div class="bg-slate-800/40 border border-slate-700/50 rounded-3xl p-4 flex flex-col hover:border-indigo-500/50 transition-all duration-300">
                        ...
                        <div class="flex-grow space-y-1">
                            <p class="text-indigo-400 text-[10px] font-bold tracking-widest uppercase">{{ $product->category->name ?? 'Gear' }}</p>
