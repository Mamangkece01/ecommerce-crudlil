...
<head>
    ...
    <title>Tambah Produk Baru - Industrial Store</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="/">LSECOND CAR</a>
                ...
                <div class="form-container mb-5">
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Contoh: Lexus LM350" value="{{ old('name') }}" required>
                        </div>
