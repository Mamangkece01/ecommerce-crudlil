    ...
    <div class="py-12 min-h-screen" style="background: linear-gradient(rgba(15, 23, 42, 0.8), rgba(15, 23, 42, 0.8)), url('https://images.unsplash.com/photo-1493238792000-8113da705763?w=1920&h=1080&fit=crop'); background-size: cover; background-position: center; background-attachment: fixed;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-3xl font-bold text-white text-center md:text-left">Katalog Mobil</h1>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8">
                @foreach($products as $product)
                    <div class="bg-indigo-900 rounded-3xl p-3 border border-indigo-700 hover:border-indigo-400 hover:shadow-2xl hover:shadow-indigo-500/50 transition-all duration-300 group flex flex-col min-h-[22rem]">

                        {{-- Image Section --}}
                        <div class="relative aspect-square bg-indigo-950 rounded-2xl mb-3 overflow-hidden flex items-center justify-center p-2">
            ...
            @if($products->isEmpty())
                <div class="text-center py-20">
                    <p class="text-white text-xl bg-indigo-900/50 p-6 rounded-2xl inline-block">Yah, mobil di kategori ini belum tersedia, Bro.</p>
                </div>
            @endif
        </div>
    </div>
